    ...
    public static String processEvent(Map<String, String> map) {
        ...
        if (event.equals(MessageUtil.EVENT_TYPE_CLICK)) { //自定义菜单点击事件
            ...
            if (eventKey.equals("11")) {
                respContent = "欢迎您访问陆家嘴金领驿站积分系统，<a href=\"http://dj.dlbdata.cn/?openId="+openId+"\">免密登录请点击</a>";
            } else if (eventKey.equals("12")) {
                respContent = "公交查询菜单项被点击！";
            } else if (eventKey.equals("13")) {
                respContent = "周边搜索菜单项被点击！";
            } else if (eventKey.equals("14")) {
                respContent = "欢迎您访问陆家嘴金领驿站积分系统，<a href=\"http://dj.dlbdata.cn/#/party/dues?openId="+openId+"\">免密登录请点击</a>";
            } else if (eventKey.equals("21")) {
                respContent = "欢迎您访问陆家嘴金领驿站积分系统，\n<a href=\"http://dj.dlbdata.cn/?openId="+openId+"\">免密登录请点击</a>";
